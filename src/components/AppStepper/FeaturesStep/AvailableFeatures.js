const availableFeatures = [
  ...
  },
  {
    ...
    custom:
      '//Below you will find additional shutter options with theirs default values, '
      + "which you can modify by removing '//' before it\n\n"
      + '//#define SHUTTER_RELAY_OPERATION_TIME 100 // wait for direction relay 0.1sec before power up main relay\n\n'
      + '//#define MOTOR_STOP_TIME 500 // wait 0.5 second after stop to do any other action. '
      + 'e.g. move in the opposite direction\n\n'
